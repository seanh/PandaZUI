...
class HBoxList(BoxList):
    ...
    def layout(self):
        """Arrange all of the boxes in this boxlist in a horizontal line."""
        ...
        for box in self.boxes:
            ...
            # Move `box` right by a distance of `margin`.        
            box.setPos(box.getPos() + Vec3(margin,0,0))